package com.chwitkey.cherry_pick_android.presentation.ui.jobGroup
...
import com.chwitkey.cherry_pick_android.data.remote.request.user.IndustryKeyword
...
import com.chwitkey.cherry_pick_android.databinding.ActivityJobGroupBinding
import com.chwitkey.cherry_pick_android.domain.repository.UserDataRepository
import com.chwitkey.cherry_pick_android.presentation.adapter.JobGroupAdapter
import com.chwitkey.cherry_pick_android.presentation.ui.home.HomeActivity
import com.chwitkey.cherry_pick_android.presentation.ui.jobGroup.JobGroups.jobgroups
...
class JobGroupActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userDataRepository.getNameLiveData().observe(this@JobGroupActivity, Observer {
            binding.tvJobUserName.text = it.toString()
        })
