...
import com.example.cherry_pick_android.presentation.ui.scrap.DeleteScrapListener
import com.google.android.material.snackbar.Snackbar

class ScrapAdapter(private val listener: DeleteScrapListener, private val scrapNewsData: MutableList<ScrapData?>) :
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        val scrapData = scrapNewsData[position]
