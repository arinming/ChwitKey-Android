...
class SearchRecordAdapter(private val deleteListener: DeleteListener):
    ...
    private val record = ArrayList<SearchRecordEntity>()
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.binding.ibtnDeleteRecentSearch.setOnClickListener {
            deleteListener.onDeleteClick(record[position].record)
        }
    }
